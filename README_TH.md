...
- **สำหรับการใช้งาน GitHub Actions (แนะนำ):**
  - **Environment Rules**: ตั้งค่า `production` environment ในเมนู Settings > Environments
  - **Action Activation**: เปิดใช้งาน "Allow all actions" ในเมนู Settings > Actions > General
